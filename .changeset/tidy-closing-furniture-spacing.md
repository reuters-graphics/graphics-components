...
Add a new `Compositions/Default page` Storybook reference that assembles a complete graphics page — headline, body text, a feature photo, a graphic block, a video, and the closing furniture (info box, end notes, share bar, bio box and referral block) — from a single typed `content` object. It ships light and dark-theme variants plus a smoke-test play function to document the standard article-well rhythm end to end.
