...
Your docs TK...
`})}),`
`,e.jsx(o.p,{children:"From there, write whatever you need in markdown."})]})}}const p=()=>{throw new Error("Docs-only story")};p.parameters={docsOnly:!0};const t={title:"Contributing/Writing docs pages",parameters:{...i},tags:["stories-mdx"],includeStories:["__page"]};t.parameters=t.parameters||{};t.parameters.docs={...t.parameters.docs||{},page:d};const M=["__page"];export{M as __namedExportsOrder,p as __page,t as default};
//# sourceMappingURL=writing-docs-stories.stories-e7f96924.js.map
