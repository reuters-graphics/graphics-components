import{S as Se,i as Ie,s as Me,v as Re,d as k,M as R,t as g,w as x,h as w,x as ee,f as A,N as Be,y as Ke,D as Ge,g as z,m as q,j as X,o as v,z as B,F as $,b as f,c as W,O as De,e as O,P as Ce,Z as me,_ as ye,E as be,l as re,u as oe,p as ie,q as fe,C as te,n as ne,k as Ye}from"./index-85f88930.js";import{g as Pe,a as je}from"./spread-8a54911c.js";import{p as Ze,M as Qe,T as $e,S as se}from"./collect-stories-fa95313f.js";import{g as xe}from"./globals-7f7f1b26.js";import{B as et}from"./Block-d1b8152c.js";import{P as tt}from"./PaddingReset-c34038dd.js";import{t as nt}from"./throttle-dfed7c30.js";import{b as ge,w as at}from"./withParams-47e2ab71.js";import"./isObject-32699ff3.js";import"./now-bd49f550.js";import"./isSymbol-50749e90.js";const lt=`A before and after image comparison component.
...
div.overlay p {
  color: #ffffff;
}`,f(l,"lang","scss")},m(t,s){q(e,t,s),k(t,n,s),k(t,l,s),r=!0},p(t,s){const o={};s&10&&(o.$$scope={dirty:s,ctx:t}),e.$set(o)},i(t){r||(g(e.$$.fragment,t),r=!0)},o(t){w(e.$$.fragment,t),r=!1},d(t){t&&(A(n),A(l)),X(e,t)}}}function At(a){let e,n,l,r,t,s,o,I,M,D;const P=[{title:"Components/BeforeAfter"},{component:Y},a[0]];let j={};for(let i=0;i<P.length;i+=1)j=te(j,P[i]);e=new Qe({props:j}),l=new $e({props:{$$slots:{default:[mt,({args:i})=>({2:i}),({args:i})=>i?4:0]},$$scope:{ctx:a}}}),t=new se({props:{name:"Default",args:{beforeSrc:ce,beforeAlt:"Satellite image of Russian base at Myrne taken on July 7, 2020.",afterSrc:pe,afterAlt:"Satellite image of Russian base at Myrne taken on Oct. 20, 2020."}}});const T=[{name:"With overlays"},ge(st)];let m={$$slots:{default:[ht]},$$scope:{ctx:a}};for(let i=0;i<T.length;i+=1)m=te(m,T[i]);o=new se({props:m});const J=[{name:"ARIA descriptions"},ge(rt)];let V={$$slots:{default:[kt]},$$scope:{ctx:a}};for(let i=0;i<J.length;i+=1)V=te(V,J[i]);return M=new se({props:V}),{c(){z(e.$$.fragment),n=B(),z(l.$$.fragment),r=B(),z(t.$$.fragment),s=B(),z(o.$$.fragment),I=B(),z(M.$$.fragment)},m(i,b){q(e,i,b),k(i,n,b),q(l,i,b),k(i,r,b),q(t,i,b),k(i,s,b),q(o,i,b),k(i,I,b),q(M,i,b),D=!0},p(i,[b]){const L=b&1?Pe(P,[P[0],P[1],je(i[0])]):{};e.$set(L);const H={};b&12&&(H.$$scope={dirty:b,ctx:i}),l.$set(H);const F={};b&8&&(F.$$scope={dirty:b,ctx:i}),o.$set(F);const S={};b&8&&(S.$$scope={dirty:b,ctx:i}),M.$set(S)},i(i){D||(g(e.$$.fragment,i),g(l.$$.fragment,i),g(t.$$.fragment,i),g(o.$$.fragment,i),g(M.$$.fragment,i),D=!0)},o(i){w(e.$$.fragment,i),w(l.$$.fragment,i),w(t.$$.fragment,i),w(o.$$.fragment,i),w(M.$$.fragment,i),D=!1},d(i){i&&(A(n),A(r),A(s),A(I)),X(e,i),X(l,i),X(t,i),X(o,i),X(M,i)}}}function Ot(a){return[{...at(lt),argTypes:{handleColour:{control:"color"},width:{control:"select",options:["normal","wide","wider","widest","fluid"]}}}]}class St extends Se{constructor(e){super(),Ie(this,e,Ot,At,Me,{})}}const ae=Ze(St,{meta:{title:"Components/BeforeAfter"},stories:{"tpl:default":{name:"default",template:!0,source:"<BeforeAfter {...args} />",hasArgs:!0},Default:{name:"Default",template:!1,source:"",hasArgs:!1},WithOverlays:{name:"With overlays",template:!1,source:`<BeforeAfter
  beforeSrc="{beforeImg}"
  beforeAlt="Satellite image of Russian base at Myrne taken on July 7, 2020."
  afterSrc="{afterImg}"
  afterAlt="Satellite image of Russian base at Myrne taken on Oct. 20, 2020."
...
//# sourceMappingURL=BeforeAfter.stories-451204d5.js.map
