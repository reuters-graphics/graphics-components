import{S as C,i as W,s as q,R as be,q as Ce,w as b,D as y,aa as ne,a as _,z as m,N as mt,u as We,r as qe,v as De,b as v,t as T,d as k,o as Mt,P as Pt,f as le,e as D,g as j,c as R,a5 as Te,h as Z,j as A,x as c,y as J,m as I,k as K,l as G,n as B,p as Q,E as P,W as At,a3 as ve,a4 as we,M as je,Y as It,T as Se,C as h}from"./index-25af778d.js";import{p as Bt,M as $t,T as Ct,S as ue}from"./collect-stories-cce06d4a.js";import{m as F}from"./marked.esm-76161808.js";import{B as ie}from"./Block-9c89ee1a.js";import{a as se,w as Wt}from"./withParams-90715500.js";const qt=`The \`Scroller\` component helps you quickly create basic scrollytelling graphics with several layout options.
...
Lorem ipsum`,altText:"The same map now highlights three locations near 98th Street where something particulary important happened."}],foregroundPosition:"middle",backgroundWidth:"fluid",embeddedLayout:"fb",embedded:!1}},se(Ue)];let N={};for(let g=0;g<E.length;g+=1)N=Q(N,E[g]);return f=new ue({props:N}),{c(){A(e.$$.fragment),t=y(),A(s.$$.fragment),n=y(),A(r.$$.fragment),l=y(),A(a.$$.fragment),i=y(),A(d.$$.fragment),u=y(),A(f.$$.fragment)},m(g,M){I(e,g,M),_(g,t,M),I(s,g,M),_(g,n,M),I(r,g,M),_(g,l,M),I(a,g,M),_(g,i,M),I(d,g,M),_(g,u,M),I(f,g,M),p=!0},p(g,[M]){const de=M&4?K(w,[w[0],M&0&&{component:fe},M&4&&G(g[2])]):{};e.$set(de);const Y={};M&24&&(Y.$$scope={dirty:M,ctx:g}),s.$set(Y);const X=M&3?K($,[$[0],M&3&&{args:gt(g[1],g[0])},M&0&&G(se(Ve))]):{};a.$set(X);const x=M&0?K(U,[U[0],M&0&&{args:{steps:[{background:O,backgroundProps:{colour:"red"},foreground:re},{background:O,backgroundProps:{colour:"blue"},foreground:`#### Step 2
...
Lorem ipsum`,altText:"The same map now highlights three locations near 98th Street where something particulary important happened."}],foregroundPosition:"middle",backgroundWidth:"fluid",embeddedLayout:"fb",embedded:!1}},M&0&&G(se(Ue))]):{};f.$set(ee)},i(g){p||(v(e.$$.fragment,g),v(s.$$.fragment,g),v(r.$$.fragment,g),v(a.$$.fragment,g),v(d.$$.fragment,g),v(f.$$.fragment,g),p=!0)},o(g){T(e.$$.fragment,g),T(s.$$.fragment,g),T(r.$$.fragment,g),T(a.$$.fragment,g),T(d.$$.fragment,g),T(f.$$.fragment,g),p=!1},d(g){B(e,g),g&&k(t),B(s,g),g&&k(n),B(r,g),g&&k(l),B(a,g),g&&k(i),B(d,g),g&&k(u),B(f,g)}}}function En(o){const e={AiMap1:pe,AiMap2:ge,AiMap3:me},t={Type:"scroller",Width:"fluid",ForegroundPosition:"middle",ID:"my-scroller",StackBackground:"true",Steps:[{Background:"AiMap1",Text:`#### Step 1
