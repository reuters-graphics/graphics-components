import{M as c}from"./chunk-PCJTTTQV-8ea8b36c.js";import{p as a,j as e}from"./jsx-runtime-539b76a3.js";import{u as i}from"./index-297ebefe.js";import"./iframe-647e33a7.js";import"../sb-preview/runtime.js";import"./extends-b40c5bac.js";import"./_commonjsHelpers-725317a4.js";import"./index-d475d2ea.js";import"./index-d37d4223.js";import"./index-1a79a776.js";import"./index-356e4a49.js";const h=""+new URL("scss-start-2a80c71b.png",import.meta.url).href,l=""+new URL("scss-highlight-be092e13.png",import.meta.url).href,d=""+new URL("scss-inspector-ad61f9f6.png",import.meta.url).href,p=""+new URL("scss-change-08eee85b.png",import.meta.url).href,m=""+new URL("scss-test-248bae69.png",import.meta.url).href,g=""+new URL("scss-winning-4f1df231.png",import.meta.url).href;function u(n={}){const{wrapper:r}=Object.assign({},i(),n.components);return r?e.jsx(r,{...n,children:e.jsx(o,{})}):o();function o(){const s=Object.assign({p:"p",img:"img",h1:"h1",h2:"h2",code:"code",em:"em",pre:"pre",h4:"h4",strong:"strong"},i(),n.components);return e.jsxs(e.Fragment,{children:[e.jsx(c,{title:"Guides/Customising components with SCSS",parameters:{...a}}),`
...
`,e.jsx(s.pre,{children:e.jsx(s.code,{className:"language-css",children:`figure#my-before-after .overlay-container {
  bottom: 0;
}
`})}),`
...
`,e.jsx(s.pre,{children:e.jsx(s.code,{className:"language-html",children:`<div id="my-before-after">
  <BeforeAfter />
</div>
`})}),`
`,e.jsx(s.p,{children:"... and use that, instead!"}),`
`,e.jsx(s.pre,{children:e.jsx(s.code,{className:"language-css",children:`div#my-before-after figure .overlay-container {
  bottom: 0;
}
`})}),`
...
`,e.jsxs(s.p,{children:["Yep, as a last result. Just be sure your style rule is ",e.jsx(s.strong,{children:"very specific"})," and not something generic that might apply to other elements like ",e.jsx(s.code,{children:"div.container"}),"."]})]})}}const w=()=>{throw new Error("Docs-only story")};w.parameters={docsOnly:!0};const t={title:"Guides/Customising components with SCSS",parameters:{...a},tags:["stories-mdx"],includeStories:["__page"]};t.parameters=t.parameters||{};t.parameters.docs={...t.parameters.docs||{},page:u};const D=["__page"];export{D as __namedExportsOrder,w as __page,t as default};
//# sourceMappingURL=customising-with-scss.stories-2abb8978.js.map
