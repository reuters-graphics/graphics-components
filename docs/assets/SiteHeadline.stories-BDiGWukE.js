import{S as B,i as K,s as P,c as h,m as g,t as y,a as b,d as k,q as T,o as U,f as m,h as _,j as w,k as S,e as D,x as H,l as V,n as z}from"./index-C9aKRT5A.js";import{g as q,a as Q}from"./spread-CgU5AtxT.js";import{w as O,p as R,T as Z,S as A,a as j}from"./collect-stories-ceFdpR5E.js";import{B as M}from"./Block-C7biTRWl.js";import{B as N}from"./Byline-CgwnbxHA.js";import"./each-D6YF6ztN.js";import"./_commonjsHelpers-BosuxZz1.js";import"./journalize-K6hK94UL.js";const $=`A simplified Reuters Graphics headline, loosely modelled off our dotcom site.
...
/>
\`\`\`
`;function Y(r){let e,n;const t=[r[1]];let a={};for(let i=0;i<t.length;i+=1)a=V(a,t[i]);return e=new v({props:a}),{c(){h(e.$$.fragment)},m(i,o){g(e,i,o),n=!0},p(i,o){const l=o&2?q(t,[Q(i[1])]):{};e.$set(l)},i(i){n||(y(e.$$.fragment,i),n=!0)},o(i){b(e.$$.fragment,i),n=!1},d(i){k(e,i)}}}function x(r){let e,n;return e=new v({props:{hed:r[0].Hed,section:r[0].Section,sectionUrl:r[0].SectionUrl,authors:r[0].Authors.split(","),publishTime:r[0].Published}}),{c(){h(e.$$.fragment)},m(t,a){g(e,t,a),n=!0},p:z,i(t){n||(y(e.$$.fragment,t),n=!0)},o(t){b(e.$$.fragment,t),n=!1},d(t){k(e,t)}}}function ee(r){let e,n,t,a,i,o;e=new Z({props:{$$slots:{default:[Y,({args:s})=>({1:s}),({args:s})=>s?2:0]},$$scope:{ctx:r}}}),t=new A({props:{name:"Default",args:{section:"Graphics",sectionUrl:"https://graphics.reuters.com",hed:"Ukraine makes surprising gains in counteroffensive",authors:["Dea Bankova","Michael Ovaska","Samuel Granados","Prasanta Kumar Dutta"],publishTime:new Date("2021-09-12").toISOString(),updateTime:new Date("2021-09-12T13:57:00").toISOString()}}});const l=[{name:"🚀 QUICKIT"},j(X)];let c={$$slots:{default:[x]},$$scope:{ctx:r}};for(let s=0;s<l.length;s+=1)c=V(c,l[s]);return i=new A({props:c}),{c(){h(e.$$.fragment),n=U(),h(t.$$.fragment),a=U(),h(i.$$.fragment)},m(s,u){g(e,s,u),_(s,n,u),g(t,s,u),_(s,a,u),g(i,s,u),o=!0},p(s,[u]){const f={};u&6&&(f.$$scope={dirty:u,ctx:s}),e.$set(f);const p={};u&4&&(p.$$scope={dirty:u,ctx:s}),i.$set(p)},i(s){o||(y(e.$$.fragment,s),y(t.$$.fragment,s),y(i.$$.fragment,s),o=!0)},o(s){b(e.$$.fragment,s),b(t.$$.fragment,s),b(i.$$.fragment,s),o=!1},d(s){s&&(S(n),S(a)),k(e,s),k(t,s),k(i,s)}}}const te={title:"Components/SiteHeadline",component:v,...O($),argTypes:{hedSize:{control:"select",options:["small","normal","big"]}}};function ne(r){return[{Section:"Global News",SectionUrl:"",Hed:"A beautiful page",Authors:"Samuel Granados, Dea Bankova",Published:"2022-09-12T08:30:00.000Z",Updated:""}]}class ie extends B{constructor(e){super(),K(this,e,ne,ee,P,{})}}const I=R(ie,{meta:{title:"Components/SiteHeadline"},stories:{"tpl:default":{name:"default",template:!0,source:"<SiteHeadline {...args} />",hasArgs:!0},Default:{name:"Default",template:!1,source:"",hasArgs:!1},QUICKIT:{name:"🚀 QUICKIT",template:!1,source:`<SiteHeadline
  hed="{content.Hed}"
  section="{content.Section}"
  sectionUrl="{content.SectionUrl}"
  authors="{content.Authors.split(',')}"
  publishTime="{content.Published}"
/>`,hasArgs:!1}},allocatedIds:["default","Template","Story","quickitDocs","withStoryDocs"]},te),fe=I.meta,me=["Default","QUICKIT"],pe=I.stories.Default,he=I.stories.QUICKIT;export{pe as Default,he as QUICKIT,me as __namedExportsOrder,fe as default};
