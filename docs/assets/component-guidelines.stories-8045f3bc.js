...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-html",children:`<script lang="ts">
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-html",children:`<button>My component</button>
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-html",children:`<svg></svg>
...
`})})]})}}const a=()=>{throw new Error("Docs-only story")};a.parameters={docsOnly:!0};const t={title:"Contributing/Component guidelines",parameters:{...i},tags:["stories-mdx"],includeStories:["__page"]};t.parameters=t.parameters||{};t.parameters.docs={...t.parameters.docs||{},page:p};const w=["__page"];export{w as __namedExportsOrder,a as __page,t as default};
//# sourceMappingURL=component-guidelines.stories-8045f3bc.js.map
